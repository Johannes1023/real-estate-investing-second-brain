...
Read [BUILDING_Roles.md](BUILDING_Roles.md) for a fully populated note in this category. Copy its structure into a separate private working folder and replace every synthetic field with a verified fact. Keep source originals outside the AI-readable folder.
